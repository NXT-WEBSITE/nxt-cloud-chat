...
if ( ! function_exists( 'nxtcc__wipe_site_data' ) ) {
	...
	function nxtcc__drop_nxtcc_tables( string $site_prefix ): void {
		$tables_pro = array(
			...
			$site_prefix . 'nxtcc_crm_segments',
			$site_prefix . 'nxtcc_crm_contact_commerce_stats',
			$site_prefix . 'nxtcc_crm_contact_product_stats',
			$site_prefix . 'nxtcc_crm_contact_coupon_stats',
			$site_prefix . 'nxtcc_crm_contact_order_status_stats',
		);
		...
		$tables_free = array(
			...
			$site_prefix . 'nxtcc_crm_deal_contacts',
			$site_prefix . 'nxtcc_crm_deals',
			$site_prefix . 'nxtcc_crm_pipeline_stages',
			$site_prefix . 'nxtcc_crm_pipelines',
			$site_prefix . 'nxtcc_crm_saved_views',
			$site_prefix . 'nxtcc_crm_tasks',
			$site_prefix . 'nxtcc_contact_lifecycle_stage',
			$site_prefix . 'nxtcc_crm_lifecycle_stages',
			$site_prefix . 'nxtcc_crm_activities',
			$site_prefix . 'nxtcc_assignment_routing_state',
			$site_prefix . 'nxtcc_contact_assignment_history',
			$site_prefix . 'nxtcc_contact_assignments',
			$site_prefix . 'nxtcc_tag_contact_map',
			$site_prefix . 'nxtcc_group_contact_map',
			$site_prefix . 'nxtcc_contacts',
			$site_prefix . 'nxtcc_tags',
			$site_prefix . 'nxtcc_groups',
			$site_prefix . 'nxtcc_user_settings',
			$site_prefix . 'nxtcc_tenant_user_access',
			$site_prefix . 'nxtcc_access_teams',
